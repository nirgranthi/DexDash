...
<a href="https://dex-dash-beta.vercel.app/" target="_blank">
...
* **Smart Search:** Includes an autocomplete dropdown for popular tokens (SOL, PEPE, WIF, etc.) and supports searching by contract address.

* **Mobile Optimized:** The chart automatically adjusts aspect ratios for phone screens so it doesn't look squashed.
